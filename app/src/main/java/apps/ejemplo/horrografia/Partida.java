...
public class Partida extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mp = MediaPlayer.create(this, R.raw.snowy_hill);
        mp.setLooping(true);
        mp.seekTo(0);
            ...
            public void onClick(View view) {
                if (!isAnswered()){
                    if(!(respuesta.getText().toString().isEmpty())){
                        ...
                        Toast.makeText(Partida.this,"Por favor ingrese una respuesta",Toast.LENGTH_SHORT).show();
        ...
        if (lapCounter <= lapCountTotal){
            if(itemCounter < itemCountTotal){
                ...
                if (getErrores() < getCurrentItem().getErrores_no_permitidos()){
                    ...
                    Intent gameover = new Intent(Partida.this,GameOver.class);
                    ...
                    Partida.this.startActivity(gameover);
                    Partida.this.finish();
                }
            ...
            Intent tableroPuntuacion = new Intent(Partida.this,Puntuacion.class);
            ...
            Partida.this.startActivity(tableroPuntuacion);
            Partida.this.finish();
        }
    ...
    private void getData(int etapa, int nivel) {
        ...
        RequestQueue cola = Volley.newRequestQueue(Partida.this);
