...
public class Home extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button ayuda = findViewById(R.id.btnAyuda);
        ayuda.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentAyuda = new Intent(Home.this, Ayuda.class);
                intentAyuda.putExtra("nombre",nombre);
                Home.this.startActivity(intentAyuda);
                Home.this.finish();
            }
        });
