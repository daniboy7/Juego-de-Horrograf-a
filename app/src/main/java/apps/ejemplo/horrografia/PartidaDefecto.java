...
public class PartidaDefecto extends AppCompatActivity {
    ...
    private int chickenHeightSize;
    private int chickenWidthSize;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chicken.setBackgroundResource(R.drawable.animationchicken);
        running = (AnimationDrawable)chicken.getBackground();
        running.start();

        chickenY = 670;
        chickenX = 10;
        chicken.setY(chickenY);
        chicken.setX(chickenX);
    ...
    private void checkchickenPosition() {
        frameHeight = frame.getHeight();
        frameWidth = frame.getWidth();
        chickenHeightSize = chicken.getHeight();
        chickenWidthSize = chicken.getWidth();
